        ...
        <div className="space-y-10 text-zinc-700 dark:text-zinc-300 leading-relaxed text-base md:text-lg">
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>To respond to user inquiries/offer support.</strong></li>
          ...
          <section className="space-y-4">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Cloud Computing & Storage:</strong> Vercel (Hosting) and Supabase (Database infrastructure).</li>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-100">5. Data Retention & Security</h2>
          ...
          <section className="space-y-4">
            <h2 className="text-2xl md:text-3xl font-bold text-zinc-900 dark:text-zinc-100">6. Your Privacy Rights (GDPR & CCPA)</h2>
